...
- [x] `PinRegistry` with `lockedBond` and blast-radius pricing — `0xF0800974aE84F55508E3e31F72A52E09b19829B0`, verified, block 61714758.
...
- [x] `LockstepGuard` 7702 delegate, fail-closed, fuzzed hard — `0xee23156D1B7D64aF1b3671290DdcEf6edF734a81`; live delegated account `0x209C903f68f169C8e654e0C3C91cAdc4C4A4aFF2` carries `0xef0100ee2315…`.
